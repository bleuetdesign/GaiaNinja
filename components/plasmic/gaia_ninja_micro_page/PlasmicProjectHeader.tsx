...
import sty from "./PlasmicProjectHeader.module.css"; // plasmic-import: FpBXYviSAdVA/css
...
function PlasmicProjectHeader__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.columns__qptB9)}>
        <div className={classNames(projectcss.all, sty.column__eJt3J)}>
          <div
            className={classNames(
              projectcss.all,
        ...
        <div className={classNames(projectcss.all, sty.column__lfJBi)}>
          <div className={classNames(projectcss.all, sty.columns__axUCf)}>
            <div className={classNames(projectcss.all, sty.column__mLly0)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
              ...
              <div className={classNames(projectcss.all, sty.freeBox___2QeD2)}>
                {renderPlasmicSlot({
            ...
            <div className={classNames(projectcss.all, sty.column__kRs7)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
              ...
              <div className={classNames(projectcss.all, sty.freeBox__mOyXm)}>
                {renderPlasmicSlot({
