...
import sty from "./PlasmicContactSection.module.css"; // plasmic-import: Lp1v4s-ukCEn/css
...
function PlasmicContactSection__RenderFunc(props: {
  ...
  return (
    <Stack__
      ...
      id={"contact"}
    >
      <div className={classNames(projectcss.all, sty.freeBox__gxnpn)}>
        <h2
        ...
        <div className={classNames(projectcss.all, sty.freeBox__k4Dak)}>
          <PlasmicLink__
